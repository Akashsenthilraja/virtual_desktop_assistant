...
root = Tk()
root.geometry("760x705")
root.title("Akash's Virtual Assistant")
root.resizable(False, False)
root.config(bg="#6F8FAF")

# Main Frame
Main_frame = LabelFrame(root, padx=100, pady=27, borderwidth=3, relief="raised")
Main_frame.config(bg="#6F8FAF")
Main_frame.grid(row=0, column=1, padx=5, pady=10)

# Text Lable
Text_lable = Label(Main_frame, text="Akash's Virtual Assistant", font=("comic Sans ms", 14, "bold"), bg="#356696")
Text_lable.grid(row=0, column=0, padx=20, pady=5)

# Image
Display_Image = ImageTk.PhotoImage(Image.open("img.png"))
